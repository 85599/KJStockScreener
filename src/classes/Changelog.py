...
4. Fixed kite_session._connect() to use cached _KJScreener_openai_agents_real reference.
...
4. LLM config (provider/model/base URL) auto-saved to KJScreener.yaml on field change.
...
4. Results will be now also stored in the excel (KJScreener-result.xlsx) file.
...
2. Minor Improvements.
3. Argument added for Data download only : run KJScreener.exe -d

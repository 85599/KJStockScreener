"""
ScreeniDatabase - SQLite-based persistence layer for KJScreener.
...
class ScreeniDatabase:
    """
    SQLite-based storage replacing pickle-based persistence in KJScreener.
    ...
    def __init__(self, db_path: str = "KJScreener.db"):
        """

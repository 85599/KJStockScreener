"""
Scheduler for KJScreener Agent Harness.
APScheduler-based scheduled runs for automated stock screening.
Supports cron-style schedules from KJScreener.yaml.
...
HEARTBEAT_LOG_FILE = "KJScreener_heartbeat.log"
RESULTS_DB = "KJScreener_agent_results.db"


class AgentScheduler:
    """
    APScheduler-based scheduler for automated KJScreener agent runs.
    Reads schedule from KJScreener.yaml and runs configured personas.
    """
    ...
    def setup_from_config(self):
        """
        Set up scheduled jobs from KJScreener.yaml.
